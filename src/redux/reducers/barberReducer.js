...
export const barberAllSalonServicsReducer = (state = {},action) => {
    switch(action.type){
        case BARBER_ALL_SALON_SERVICES_REQ:
            return {loading:true}
        case BARBER_ALL_SALON_SERVICES_SUCCESS:
            return {loading:false,...action.payload}
        case BARBER_ALL_SALON_SERVICES_FAIL:
            return {loading:false,error:action.payload}
        default:
            return state
    }
...
export const groupBarberServicesByBarberIdReducer = (state = {},action) => {
    switch(action.type){
        case GROUP_BARBER_SERVICES_BARBERID_FAIL:
            return {loading:true}
        case GROUP_BARBER_SERVICES_BARBERID_SUCCESS:
            return {loading:false,...action.payload}
        case GROUP_BARBER_SERVICES_BARBERID_FAIL:
            return {loading:false,error:action.payload}
        default:
